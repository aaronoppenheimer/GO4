...
"""
Django settings for go4 project.
...
MIDDLEWARE = [
    ...
    "go4.user_timezone_middleware.UserTimezoneMiddleware",
    "django.contrib.messages.middleware.MessageMiddleware",
    "django.middleware.clickjacking.XFrameOptionsMiddleware",
    "go4.rollbar_middleware.GigORollbarNotifierMiddleware",
]

ROOT_URLCONF = "go4.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "go4.template_globals.template_globals",
            ],
        },
    },
]

FORMAT_MODULE_PATH = ["go4.formats"]

WSGI_APPLICATION = "go4.wsgi.application"
...
AUTHENTICATION_BACKENDS = [
    ...
    'go4.backends.CaseInsensitiveEmailBackend',
]
...
Q_CLUSTER = {
    "name": "DjangORM",
    "workers": 1,
    # Set timeout ridiculously high until we have a solution: https://github.com/Gig-o-Matic/go4/pull/450#issuecomment-2072130002
...
# for calling routine tasks in go4.tasks
